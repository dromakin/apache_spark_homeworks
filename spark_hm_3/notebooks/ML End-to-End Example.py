...
red_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/trueprogramdevelop@gmail.com/winequality_red.csv", sep=';')
white_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/trueprogramdevelop@gmail.com/winequality_white.csv", sep=';')
...
table_path = "dbfs:/trueprogramdevelop@gmail.com/delta/wine_data"
...
import os
os.environ["DATABRICKS_TOKEN"] = "dapid932b9dfd8fd2d2414872c74957941de-3"
...
def score_model(dataset: pd.DataFrame):
  url = 'https://adb-4147838819861729.9.azuredatabricks.net/model/wine_quality/Production/invocations'
#   url = 'https://adb-4147838819861729.9.azuredatabricks.net/model/wine_quality/7/invocations'
